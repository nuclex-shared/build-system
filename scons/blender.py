...
def register_extension_methods(environment):
    ...
    environment.AddMethod(_export_animations_fbx, "export_animations_fbx")
    environment.AddMethod(_export_animations_collada, "export_animations_collada")
...
def enumerate_blendfiles(root_directory, variant_directory = None):
    ...
    for root, directory_names, file_names in os.walk(project_directory):
        for file_name in file_names:
            ...
            if any(file_extension in s for s in blendfile_extensions):
